...
<html lang="en">
  <head>
    ...
    <!-- End plugin css for this page -->
       @if(request()->routeIs(['admin.add.pages','admin.edit.pages','area-of-work.create','area-of-work.edit','posts.create','posts.edit']))
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                ...
                <a href="{{route('admin.edit.user',auth()->user()->id)}}" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile <span class="badge badge-pill badge-danger">1</span></a>
